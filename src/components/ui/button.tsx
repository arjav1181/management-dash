...
const variantClasses = {
  ...
  secondary: 'bg-bg-tertiary text-text-primary hover:bg-bg-elevated border border-border-primary',
  ghost: 'text-text-secondary hover:text-text-primary hover:bg-bg-tertiary',
  danger: 'bg-rose text-white hover:bg-rose/90 shadow-lg shadow-rose/20',
